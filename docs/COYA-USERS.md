# 👥 UTILISATEURS NATIFS SENEGEL - ECOSYSTIA

## 🔐 Informations de connexion

**Mot de passe par défaut pour tous les utilisateurs :** `Coya2024!`
...
1. **Connexion :** Utilisez n'importe quel email de la liste avec le mot de passe `Coya2024!`

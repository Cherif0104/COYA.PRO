# Configuration des Modules par Rôle - MVP SENEGEL
...
2. **Configuration granulaire** : Les permissions peuvent être modifiées via le module "Gestion des Utilisateurs" > "Permissions Module".
